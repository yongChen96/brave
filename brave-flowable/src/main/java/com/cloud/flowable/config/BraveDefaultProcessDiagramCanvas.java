 ...
 * @author admin
 * @version 1.0
 * @description: 自定义已经走过的流程高亮连接线和高亮图标
 * @date 2021/7/6 10:12
 */
public class BraveDefaultProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
